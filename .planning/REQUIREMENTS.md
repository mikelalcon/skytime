...
- [x] **AUTH-04**: A self-hosted mTLS reload-on-SIGHUP snippet in temporal-auth.md. Production cluster rotates client certs; SIGHUP triggers `client.Options.ConnectionOptions.TLS` reload without restart.
...
| AUTH-04 | Phase 7.5 | 07.5-05-snippet-mtls-sighup | Complete |
