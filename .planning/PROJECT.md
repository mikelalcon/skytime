...
---
*Last updated: 2026-05-05 after Phase 04.3 completion (first complete documentation set + stdlib-only `cmd/skytime-docgen` source-driven reference generator with `//go:generate` + drift CI gate; 5 human-verification items captured in `04.3-HUMAN-UAT.md` for prose/rendering/E2E judgment)*
